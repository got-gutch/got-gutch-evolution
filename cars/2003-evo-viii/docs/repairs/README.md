...
|-----------|-------------|-------|
| LCA Rear Bushing (Large) | PFF44-202G | **Highly Recommended.** Caster Adjustable / Anti-Lift Kit. This is the definitive cure for the "metallic bang" under braking. Replaces weak, oil-filled factory rubber. |
...
The PFF44-202G kit physically cannot bottom out like the stock rubber does when it's torn. Under braking, the control arm stays exactly where it belongs, and brake pedal feel becomes much more consistent.
...
## Catalytic Converter Flange Stud Removal & Test Pipe Replacement

| Field     | Value        |
|-----------|-------------|
| Date      | July 2026   |
| Status    | Complete |
| Parts     | OEM Catalytic Converter (studs removed), FB Boosted Fabrication Test Pipe (replaced) |
| Reason    | Removed factory exhaust manifold flange studs from OEM catalytic converter to allow proper installation. Replaced FB test pipe as part of exhaust system refinement. |
| Notes     | OEM catalytic converter reinstalled on car with studs removed. FB test pipe replaced to complete exhaust system update. |
...
| Notes     | Tomei exhaust paired with FB resonator installed. This exhaust modification triggered P0421 (Catalyst Efficiency) code due to race pipe. Code was subsequently disabled via ECU tuning by [tuner name]. |
